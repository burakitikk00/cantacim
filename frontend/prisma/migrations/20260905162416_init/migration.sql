...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PREPARING', 'SHIPPED', 'DELIVERED', 'CANCELLED', 'REFUNDED');

-- CreateEnum
CREATE TYPE "CustomerTier" AS ENUM ('STANDARD', 'ELITE', 'PLATINUM');

-- CreateTable
CREATE TABLE "StoreSettings" (
    "id" TEXT NOT NULL DEFAULT 'default',
    "shippingFee" DECIMAL(10,2) NOT NULL DEFAULT 90,
    "applyToFree" BOOLEAN NOT NULL DEFAULT false,
    "calcMethod" TEXT NOT NULL DEFAULT 'single',
    "freeShippingActive" BOOLEAN NOT NULL DEFAULT false,
    "internationalActive" BOOLEAN NOT NULL DEFAULT false,
    "firstPlusExtra" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "thresholdValue" DECIMAL(10,2) NOT NULL DEFAULT 500,
    "belowThresholdFee" DECIMAL(10,2) NOT NULL DEFAULT 90,
    "aboveThresholdFee" DECIMAL(10,2) NOT NULL DEFAULT 0,
    "deliveryMethods" JSONB,
...
CREATE TABLE "Coupon" (
    ...
    "buyX" INTEGER,
    "getY" INTEGER,
    "discountMethod" TEXT NOT NULL DEFAULT 'AUTO',
    "targetTier" "CustomerTier",
    "targetUserId" TEXT,
    "scope" TEXT NOT NULL DEFAULT 'ALL',
    "minRequirement" TEXT,
    "minReqValue" DECIMAL(10,2),
...
CREATE TABLE "Notification" (
    ...
    "isModalShown" BOOLEAN NOT NULL DEFAULT false,
    "link" TEXT,
    "entityId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "_CustomerGroupToDiscount" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL,

    CONSTRAINT "_CustomerGroupToDiscount_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Product_shopierId_key" ON "Product"("shopierId");
...
-- CreateIndex
CREATE INDEX "Product_originalCategoryId_idx" ON "Product"("originalCategoryId");
...
-- CreateIndex
CREATE INDEX "Coupon_targetTier_idx" ON "Coupon"("targetTier");

-- CreateIndex
CREATE INDEX "Coupon_targetUserId_idx" ON "Coupon"("targetUserId");
...
-- CreateIndex
CREATE UNIQUE INDEX "StockNotification_userId_variantId_key" ON "StockNotification"("userId", "variantId");
...
-- CreateIndex
CREATE INDEX "_CustomerGroupToDiscount_B_index" ON "_CustomerGroupToDiscount"("B");
...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_originalCategoryId_fkey" FOREIGN KEY ("originalCategoryId") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_CustomerGroupToDiscount" ADD CONSTRAINT "_CustomerGroupToDiscount_A_fkey" FOREIGN KEY ("A") REFERENCES "CustomerGroup"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_CustomerGroupToDiscount" ADD CONSTRAINT "_CustomerGroupToDiscount_B_fkey" FOREIGN KEY ("B") REFERENCES "Discount"("id") ON DELETE CASCADE ON UPDATE CASCADE;
